...
To make the game fair Brownklow should pay out R mean (saveBank)
...
hist(saveBank)
``` 
To make the game fair, Brownlow pay out "r mean(saveBank)" the score is 
